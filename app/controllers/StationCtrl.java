/**
 * Main Class for controlling all readings for each weather Station. Calls methods to return the latest reading at the
 * station,delete readings from the station, delete the station and add a reading to the station.
 *

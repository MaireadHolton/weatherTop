/**
 * Class to perform calculations on weather readings. Includes methods to return the latest readings for temperature,
 * weather code, wind speed, wind direction and pressure. Also has methods to calculate the temperature in fahrenheit,
 * determine the wind chill, calculate the wind direction, determine the weather condition based on the weather code,
 * display an appropriate weather icon, calculate the maximum and minimum temperature, wind speed and pressure and
 * a method to determine the beaufort label based on the wind speed.
 *
